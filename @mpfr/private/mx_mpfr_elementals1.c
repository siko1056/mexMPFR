...
void mexFunction( int nlhs, mxArray *plhs[],
  ...
  int hasDouble = 0;
  int subDouble = 0;
  int (*fp)(mpfr_t rop, mpfr_t op1, mpfr_t op2, mpfr_rnd_t rnd) = NULL;
  int (*fpd)(mpfr_t rop, mpfr_t op1, double pop, mpfr_rnd_t rnd) = NULL;
  int (*dfp)(mpfr_t rop, double pop, mpfr_t op1, mpfr_rnd_t rnd) = NULL;
